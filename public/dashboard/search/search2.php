...
<?php include(SHARED_PATH . '/dashboard_navigation.php'); ?>
  ...
  ?>
    <?php if ($nextpageoffset > 10) {
      ?>
      <a class="action" href="<?php echo url_for('/dashboard/search/search2.php?offset=' . $prevpageoffset); ?>">&nbsp;&laquo&laquoPrevious 10 Results&nbsp&nbsp&nbsp&nbsp</a>
    <?php
  }
    ?>
    ...
    if ($nextpageoffset < $total_number_questions && $rowcounter == 10) {
        ?>
  <a class="action" href="<?php echo url_for('/dashboard/search/search2.php?offset=' . $nextpageoffset); ?>">&nbsp;Next 10 Results&nbsp;&raquo&raquo</a>
  <?php
    } ?>
...
<br /><br />
  ...
  <?php while ($bookinfo = mysqli_fetch_assoc($question_result)) {
    ...
    <tr bgcolor='<?php echo $class; ?>'>
      ...
      <td><a class="action" href="<?php echo url_for('/dashboard/search/delete.php?id=' . h(u($bookinfo['id']))); ?>">&nbsp;Delete</a></td>
    </tr>
    <tr>
